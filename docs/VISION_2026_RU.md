...
### 2. AR "Dish-o-Vision" (Блюда в AR)
*   **Концепт:** Наведи камеру на меню (или фасад), чтобы увидеть летающие 3D-модели блюд, рейтинги и аллергены поверх реальности.
*   **Реализация:** WebXR + Распознавание изображений.

### 3. "GastroDAO" (Токенизация)
