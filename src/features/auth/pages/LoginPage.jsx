        ...
        <div className="min-h-screen w-full bg-white flex overflow-hidden">
            ...
            <div className="hidden lg:flex lg:w-[45%] relative bg-black text-white p-12 flex-col justify-between overflow-hidden">
                ...
                <div className="relative z-10">
                    <div className="bg-white/10 w-fit px-4 py-2 rounded-full flex items-center gap-2 mb-8 backdrop-blur-md border border-white/10">
            ...
            <div className="flex-1 relative flex items-center justify-center p-6 bg-gray-50/50">
                ...
                >
                    <motion.div variants={itemVariants} className="text-center mb-10">
                        <div className="w-12 h-12 bg-blue-600 rounded-2xl flex items-center justify-center text-white font-bold text-xl mx-auto mb-6 lg:hidden">G</div>
                    ...
                    <motion.div variants={itemVariants} className="mt-8 text-center space-y-6">
                        ...
                        <p className="text-gray-500 text-sm">
                            Don't have an account? <a href="#" className="font-bold text-blue-600 hover:text-blue-700">Sign up free</a>
                        </p>
                    </motion.div>
                </motion.div>
            </div>
